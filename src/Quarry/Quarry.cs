...
namespace Quarry
{
    public class Quarry : StateMachineComponent<Quarry.SMInstance>
    {
        ...
        public class SMInstance : GameStateMachine<States, SMInstance, Quarry, object>.GameInstance
        {
            public SMInstance(Quarry master) : base(master) { }
        }

        public class States : GameStateMachine<States, SMInstance, Quarry>
        {
